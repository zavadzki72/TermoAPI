...
namespace Termo.Infrastructure.Repositories
{
    public class WorldRepository : IWorldRepository
    {
        ...
        {
            var world = await _dbContext.Worlds.FirstOrDefaultAsync(x => x.Name.Equals(worldStr));
        ...
        {
            var worlds = await _dbContext.Worlds.Where(x => x.WorldStatus != WorldStatusEnumerator.WATING).ToListAsync();
